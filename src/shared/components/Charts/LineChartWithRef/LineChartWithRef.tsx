import React, {
 useRef, useEffect, useState, forwardRef, Ref,
} from 'react';
...
interface Props {
  ...
  height?: number;
  width?: number;
  svgContainerRef?: Ref<HTMLDivElement>;
}

export function LineChartWithRef({
  data,
  yAxisLabel,
  height,
  width,
...
`);
  ...
  const Chart = forwardRef<HTMLDivElement>((_, ref) => (
